...
function suggestAllocation(monthlyIncome, fixedExpensesTotal, goalWeights, hasSavingsGoal) {
    if (monthlyIncome === 0) {
        return {
            fixedExpenses: 40,
            variableExpenses: 20,
            investments: 15,
            savingsGoal: hasSavingsGoal ? 15 : 0,
            cashBuffer: hasSavingsGoal ? 10 : 25
        };
    }
    ...
    if (total === 0) {
        return {
            ...
            cashBuffer: Math.round(remaining * (hasSavingsGoal ? 0.2 : 0.4))
        };
    }
...
function reducer(state, action) {
    switch(action.type){
        ...
        case "UPDATE_RISK_EVENT":
            return {
                ...state,
                riskEvents: state.riskEvents.map((e)=>e.id === action.event.id ? action.event : e)
            };
        case "REMOVE_RISK_EVENT":
            return {
                ...state,
                riskEvents: state.riskEvents.filter((e)=>e.id !== action.eventId)
            };
        ...
        case "DISMISS_NOTIFICATION":
            return {
                ...state,
                notifications: state.notifications.map((n)=>n.id === action.notificationId ? {
                        ...n,
                        isDismissed: true
                    } : n)
            };
...
function AppProvider({ children }) {
    _s();
    const [state, dispatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReducer"])(reducer, null, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveState"])(state);
        }
    }["AppProvider.useEffect"], [
        state
    ]);
...
_s(AppProvider, "KbKDpRykewaxcxtso3VhbHZxRso=");
_c = AppProvider;
function useApp() {
    _s1();
...
//# sourceMappingURL=src_14528ee9._.js.map