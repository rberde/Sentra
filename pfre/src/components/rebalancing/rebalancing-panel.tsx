...
export function RebalancingPanel() {
  ...
  const handleSelect = (plan: RebalancingPlan) => {
    ...
    const aiRuleIdSuffix = plan.id;
    const aiRules = [
      {
        id: `ai_spending_${aiRuleIdSuffix}`,
      ...
      {
        id: `ai_liquidity_${aiRuleIdSuffix}`,
      ...
      {
        id: `ai_risk_score_${aiRuleIdSuffix}`,
