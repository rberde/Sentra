...
import { getAllocationDriftCategories, getPercentUsed, getVariableSpendingCap } from "@/lib/engine/monitoring";
...
export async function GET(req: Request) {
  ...
  if (shouldRun("spending") && activePlan && reallocation) {
    ...
    const percentUsed = getPercentUsed(totalVariable, variableCap);
  ...
  if (shouldRun("drift") && activePlan && reallocation) {
    const drifts = getAllocationDriftCategories({
      income,
